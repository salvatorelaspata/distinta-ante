...
export const formulario = (l) => (a) => (b) => (h) => (t)=> {
    ...
    if (a === 1) {
        ...
        if(t){
            ...
            dueAnte[1].baseManiglia = dueAnte[0].baseManiglia - constants.DifferenzaFascione//132;    // fascione
            dueAnte[2].baseManiglia = dueAnte[1].baseManiglia  - constants.DifferenzaMezzaLamella//27;    // mezza lamella
            dueAnte[3].baseManiglia = dueAnte[2].baseManiglia + constants.AggiuntaLamella//11;     // lamella
    
            dueAnte[1].baseLaterale = dueAnte[0].baseLaterale - constants.DifferenzaFascione//132;    // fascione
            dueAnte[2].baseLaterale = dueAnte[1].baseLaterale - constants.DifferenzaMezzaLamella//27;     // mezza lamella
            dueAnte[3].baseLaterale = dueAnte[2].baseLaterale + constants.AggiuntaLamella//11;     // lamella
        }
    }
